...
const createContents = (date) => {
  ...
  <head>
    ...
    <link rel="stylesheet" href="https://process.im-d.dev/Im-Infographic-FE/style@1.css">
  </head>
  ...
  <script type="module">
    ...
    import APP from 'https://process.im-d.dev/Im-Infographic-FE/src/index@1.js';

    const fetchAuthor = fetch('https://process.im-d.dev/Im-Infographic-BE/data/author/${fileName}.json').then(res => res.json())
    const fetchIMDInfo = fetch('https://process.im-d.dev/Im-Infographic-BE/data/imd_info/${fileName}.json').then(res => res.json())
    const fetchIMDRepos = fetch('https://process.im-d.dev/Im-Infographic-BE/data/imd_repos/${fileName}.json').then(res => res.json())
    const fetchPR = fetch('https://process.im-d.dev/Im-Infographic-BE/data/pr/${fileName}.json').then(res => res.json())
